...
/**
 * A class that represents a row in the table "Resources" in a resource
 * database.
 * 
...
public class Resource
{
    ...
    public String getPath()
    {
        ...
        ResultSet result = builder.select(SQL_COL_PATH).from(SQL_TABLE).where(SQL_COL_ID, getId())
                .executeQuery();
    ...
    public boolean setPath(String path)
    {
        ...
        int affectedRows = builder.update(SQL_TABLE).set(SQL_COL_PATH, path).where(SQL_COL_ID, getId())
                .executeUpdate();
    ...
    public String getCache()
    {
        ...
        ResultSet result = builder.select(SQL_COL_CACHED).from(SQL_TABLE).where(SQL_COL_ID, getId())
                .executeQuery();
    ...
    public boolean setCached(String cache)
    {
        ...
        int affectedRows = builder.update(SQL_TABLE).set(SQL_COL_CACHED, cache).where(SQL_COL_ID, getId())
                .executeUpdate();
    ...
    public int getTypeId()
    {
        ...
        ResultSet result = builder.select(SQL_COL_TYPE).from(SQL_TABLE).where(SQL_COL_ID, getId())
                .executeQuery();
    ...
    public boolean setType(int typeId)
    {
        ...
        int affectedRows = builder.update(SQL_TABLE).set(SQL_COL_TYPE, typeId).where(SQL_COL_ID, getId())
                .executeUpdate();
    ...
    public List<Group> getGroups()
    {
        ...
        ResultSet result = builder.select(Editor.GROUPS_RESOURCES_SQL_COL_GROUP_ID)
                ...
                .where(Editor.GROUPS_RESOURCES_SQL_COL_RESOURCE_ID, getId()).executeQuery();
    ...
    {
        return "Resource(id=" + getId() + ";path=" + getPath() + ";cache=" + getCache() + ";type="
                + getTypeId() + ")";
    }
}
